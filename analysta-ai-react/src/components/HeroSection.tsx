...
export default function HeroSection() {
  return (
    <section className="h-auto lg:h-[800px] flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-primary-50 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center lg:items-end relative z-10 w-full h-full pt-8 pb-16 lg:pt-12 lg:pb-20">
        ...
        >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 lg:mb-8 max-w-lg leading-relaxed"
          >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="relative overflow-hidden bg-primary-600/95 backdrop-blur-xl text-white px-8 py-4 rounded-[20px] font-semibold text-lg shadow-[0_8px_24px_rgba(37,99,235,0.25),inset_0_1px_1px_rgba(255,255,255,0.2),inset_0_-1px_2px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_32px_rgba(37,99,235,0.35),inset_0_1px_1px_rgba(255,255,255,0.2),inset_0_-1px_2px_rgba(0,0,0,0.1)] transition-all duration-300 flex items-center justify-center gap-2 border border-primary-500/20"
              style={{
            ...
            <motion.button
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
              className="relative overflow-hidden bg-white/60 backdrop-blur-xl text-primary-700 px-8 py-4 rounded-[20px] font-semibold text-lg shadow-[0_4px_16px_rgba(0,0,0,0.08),inset_0_1px_2px_rgba(255,255,255,0.9),inset_0_-1px_2px_rgba(0,0,0,0.05)] hover:bg-white/80 hover:shadow-[0_8px_24px_rgba(0,0,0,0.12),inset_0_1px_2px_rgba(255,255,255,0.9),inset_0_-1px_2px_rgba(0,0,0,0.05)] transition-all duration-300 flex items-center justify-center gap-2 border border-white/60"
              style={{
                backdropFilter: 'blur(20px) saturate(180%)',
                WebkitBackdropFilter: 'blur(20px) saturate(180%)',
              }}
          ...
          <div className="mt-8 lg:mt-16 relative h-24 lg:h-32">
            ...
            <motion.div
              ...
              className="absolute left-2 top-2 bg-orange-500 rounded-xl lg:rounded-2xl p-2 lg:p-3 shadow-xl"
            >
            ...
            <motion.div
              ...
              className="absolute left-20 sm:left-24 top-6 lg:top-8 bg-pink-500 rounded-xl lg:rounded-2xl p-2 lg:p-3 shadow-xl"
            >
            ...
            <motion.div
              ...
              className="absolute left-44 sm:left-52 top-1 bg-yellow-400 rounded-xl lg:rounded-2xl p-2 lg:p-3 shadow-xl"
            >
